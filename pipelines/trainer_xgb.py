...
def run_pipeline_xgb(data_path, horizon, name):
    ...
    preds, avg_metrics = walk_forward(xgboost_model, X, y, train_size=0.7, step_size=0.1)

    print(f"\n===== XGBoost Performance: {name} =====")
    print(avg_metrics)
    print("=======================================")
...
results_5m = run_pipeline_xgb("../data/btcusd_5m.csv", 12, "5 Min")
results_15m = run_pipeline_xgb("../data/btcusd_15m.csv", 16, "15 Min")
results_1h = run_pipeline_xgb("../data/btcusd_1h.csv", 24, "1H")
